...
window.requestAnimFrame = function () {
  return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (callback, element) {
    return window.setTimeout(callback, 1000 / 60); //1000ms/60.最佳循环间隔
      ...
      * @Last Modified time: 2018-11-30 19:40:47
      */
...
$(function () {
  ...
  questionNum = 0,
      //当前题号
  questionLen = _question2["default"].data.length,
      //题目个数
  userSex = 0,
      //用户选择性别，0男1女
  userName = '',
  ...
  function filterFun(value) {
    //遍历敏感词数组filter.data
    var len = _filter2["default"].data.length;
    for (var i = 0; i < len; i++) {
      //判断内容中是否包括敏感词
      if (value.indexOf(_filter2["default"].data[i]) != -1) {
  ...
  $('.loading-end-btn').on('click', function () {
    ...
    for (var _i2 = 0; _i2 < 10; _i2++) {
      var img = new Image();
      img.src = '../../images/choose/girl_' + _i2 + '.png';
    }
    /* 加载第三部分需要的图片 */
    var imgArr3_jpg = ['bg_0', 'bg_1', 'bg_2', 'bg_3', 'bg_4'];
    var imgArr3_png = ['bicycle_0', 'bird_0', 'bird_1', 'buildingFix_0', 'buildingFix_1', 'buildingFix_2', 'buildingFix_3', 'bus', 'car', 'cat_1', 'cat_1_flash', 'moon', 'train', 'wire_2'];
    var imgArr3_gif = ['bird_2', 'bird_3', 'cat_0', 'guitar', 'lamp_0', 'lamp_1', 'leaflet', 'liu', 'signal', 'stage', 'zoo'];
    preLoad(imgArr3_jpg, 'jpg');
    preLoad(imgArr3_png, 'png');
    preLoad(imgArr3_gif, 'gif');

    function preLoad(arr, format) {
      var imgUrl3 = '../../images/scene/';
      var len = arr.length;
      for (var _i3 = 0; _i3 < len; _i3++) {
        var img = new Image();
        img.src = '' + imgUrl3 + arr[_i3] + '.' + format;
      }
    }
  });
  ...
  $('.video1').on('ended', function () {
    ...
    frameAni(); */
    var canvasImgLen = canvas1Img.length;
  ...
  function page3() {
    ...
    var canImgArr = ['save_bg.jpg', 'bg/' + getRandom() + '.png', 'animal/' + getRandom() + '.png', 'music/' + getRandom() + '.png', 'tips.jpg', 'activity.jpg', 'btn_entry.png', 'btn_replay.png'],
        canImgArrLen = canImgArr.length;
    for (var _i4 = 0; _i4 < canImgArrLen; _i4++) {
      // let img = new Image();
      // img.src = '../../images/result' + canImgArr[i]
      // canvas3Img.push(img)
      canvas3Img[_i4] = new Image();
      canvas3Img[_i4].src = '../../images/result/' + canImgArr[_i4];
    }
  }
  /* 人物原地行走 */
  function walk(context2, Iw, Ih) {
    ...
    page3Obj.timer = setInterval(function () {
      context2.clearRect(0, 0, _utils.utils.oW, _utils.utils.oH);
      if (w) {
  ...
  function screenToTop() {
    ...
    if (questionNum < questionLen) {
      /* 题目修改 */
      var ques = _question2["default"].data[questionNum],
          //当前题目
      optLen = ques.option.length,
          //题目个数
      str = '<ul class="question-list">';
      $('.question').find('h3').text(ques.title);
      $('.question-list').detach('');
      for (var _i5 = 0; _i5 < optLen; _i5++) {
        str += '<li>' + ques.option[_i5] + '</li>';
      }
      str += '</ul>';
      $('.question').append(str);
    }
  ...
  function drawCan3() {
    ...
    for (var _i6 = 0; _i6 < 4; _i6++) {
      context3.drawImage(canvas3Img[_i6], 0, 0, can3Ow, can3Oh);
      newCanCont.drawImage(canvas3Img[_i6], 0, 0, can3Ow, can3Oh);
    }
    ...
    /* 绘制文案 */
    var txtNum = _result2["default"]['question_' + parseInt(Math.random() * 4)][parseInt(Math.random() * 3)];
    ...
    function drawName(canvas) {
      ...
      // newCanCont.fillStyle = "#6e737b";
      canvas.save();
      canvas.font = "600 40px Arial";
      canvas.fillText(userName, 48 * 2, 60 * 2);
      canvas.restore();
      // newCanCont.save();
      // newCanCont.font="600 40px Arial";
      // newCanCont.fillText(userName, 48*2, 60*2);
      // newCanCont.restore();
      // 绘制总结语言
      ...
      // newCanCont.font="24px Arial";
      // newCanCont.textAlign="center";
      // newCanCont.fillStyle = "#2B333D";
      // newCanCont.fillText(txtNum[0], can3Ow / 2, 12 * 2 + 430 * 2);
      // newCanCont.fillText(txtNum[1], can3Ow / 2, 12 * 5.5 + 430 * 2);
      // newCanCont.fillText(txtNum[2], can3Ow / 2, 12 * 9 + 430 * 2);
    }
