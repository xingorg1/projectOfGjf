...
var VConsole = __webpack_require__(7); //路径根据项目自己找
...
$(function () {
  ...
  */
  ...
  function initPreLoad() {
    ...
    musicAss = _utils.utils.prestrain(musicArr, musicUrl, 'mp3', function () {
      num++;
      loadAni(num);
    });
  }
  ...
  $('.loading-end-btn').on('click', function () {
    ...
    for (var _i2 = 0; _i2 < 10; _i2++) {
      var img = new Image();
      img.src = links + 'choose/girl_' + _i2 + '.png';
    }
    /* 加载第三部分需要的图片 */
  ...
  function page3() {
    ...
    for (var _i4 = 0; _i4 < canImgArrLen; _i4++) {
      ...
      canvas3Img[_i4].src = links + 'result/' + canImgArr[_i4];
    }
  }
  /* 人物原地行走 */
  ...
  function drawCan3() {
    ...
    $('.about').on('click', function () {
      var str = '<section class="page5"></section>';
      $('.main').append(str);
      $('.page5').addClass('show');
    });
    /* 重回平行世界 */
