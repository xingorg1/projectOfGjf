...
var _question = __webpack_require__(71);

var _question2 = _interopRequireDefault(_question);

var _result = __webpack_require__(73);
  ...
  $('.loading-end-btn').on('click', function () {
    ...
    function preLoad(arr, format) {
      ...
      for (var _i2 = 0; _i2 < len; _i2++) {
        var img = new Image();
        img.src = '' + imgUrl3 + arr[_i2] + '.' + format;
      }
    }
  });
...
module.exports = {"question_0":[["眼里有风，心中有爱，又乖又江湖","你是永远年轻的「追风少年」","你有一块绵软又属于自己的「心理舒适区」"],["钢铁森林，心有「猛兽」，滚烫又温柔","你是很多人眼中永远不羁的「少年」","你是外表冷静、内心狂热的「少年」"],["特立独行，态度至上，真实又果敢","你永远拥有自我主张、意气风发","你勇敢却不横冲直撞，大胆表达绝不盲从"]],"question_1":[["内心柔软的你不争不抢，佛系人生","坚强的外表下，内心却柔软","即使不明确表达，心中却有所主张"],["颜值超标的你安静为伍，优雅一生","离开一个人对你来说是巨大的考验"],["自由自在的你心比天大、萌到发光","偶尔贪玩却绝不放纵，具有冒险家精神"]],"question_2":[["偶尔避世，想知道 24 小时不工作的感觉","渴望一段「离开」的时间，过纯粹自我的时光"],["向往自然舒适的生活环境，偶尔考虑「裸辞」","旅行的意义对你来说是「永远在路上」"],["生活对你而言，每天都是光怪陆离的精致狂欢","张扬又自由，每次和你交流都活力鲜明","你永远相信，未来鲜明又年轻"]],"question_3":[["你认为，「懒」这个字促进了大半人类发明史","对友人关照有佳，有时会疏于照料自己"],["好看不重要，活下去最重要，「惜命狂魔」本尊","你的踏实和温暖，总会让人想要依靠"],["你能忍受很多苦，但蓬头垢面的苦除外","无数的深夜失眠，在黎明来时总会保持最佳状态","你很优秀，在不被看好的时候其实也很好看"]],"question_4":[["有些人想要的东西很多，而你只想要一个人的心","爱让你有了软肋，但也披上盔甲","爱到深处的时候，总觉得一切都对了"],["你的「做自己」，从不被「年龄」和「时间」限制","你只想拼尽全力过好这一生","独立冷静，知道安全感通常来源于自己"],["无论到哪儿，都在以家为原点、牵挂为半径的圆里","家是永恒的牵挂，也是永远的归宿","你相信生活需要柴米油盐，也需要惊喜和仪式感"]]}
